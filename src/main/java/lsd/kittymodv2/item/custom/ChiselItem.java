package lsd.kittymodv2.item.custom;
...
public class ChiselItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        if(Screen.hasShiftDown()) {
            tooltip.add(Text.translatable("tooltip.kittymodv2.chisel.shift_down"));
        } else {
            tooltip.add(Text.translatable("tooltip.kittymodv2.chisel"));
        }
